...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyAddressBookChanged.connect(std::bind(NotifyAddressBookChanged, this, _1, _2, _3, _4, _5));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyAddressBookChanged.disconnect(std::bind(NotifyAddressBookChanged, this, _1, _2, _3, _4, _5));
